...
<body>
    ...
    <nav class="float-r">
      <ul class="list-auto">
        ...
        <li class="timemania">
          <a href="" title="Timemania"><span class="icone"><img src="../../img/icon_timemania.png" width="20"></span> Timemania</a>
        </li>
        <li class="duplasena">
    ...
    <div class="main">
      ...
      <h4><strong>TIMEMANIA</strong></h4>
        <span class="font14">Confira o resultado, ganhadores e prêmios da Timemania nos sorteios que são realizados nas terças-feiras, 
          quintas-feiras e sábados a partir das 20 horas.</span>
