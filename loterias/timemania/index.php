  ...
  <div class="containermain">
    ...
    <div class="main">
      <div class="tloterias ttimemania">
        ...
        <h6><strong>TIMEMANIA - Resultados, prêmios e cidades dos ganhadores.</strong></h6>
        <span class="font14">Confira o resultado, ganhadores e prêmios da Timemania. Os sorteios são realizados na segunda, terça, 
      ...
      <div class="right">        
          ...
          <div class="top_right">
            <h5><strong>Resultado da Timemania 2271, de 02/07/2021.</strong></h5>
          </div> <!-- end top_right -->
