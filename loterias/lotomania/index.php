  ...
  <div class="containermain">
    ...
    <div class="main">
      <div class="tloterias tlotomania">
        ...
        <h6><strong>LOTOMANIA - Resultados, prêmios e cidades dos ganhadores.</strong></h6>
        <span class="font14">Confira o resultado, ganhadores e prêmios da Lotomania. Os sorteios são realizados na segunda, terça, 
      ...
      <div class="right">        
          ...
          <div class="top_right">
            <h5><strong>Resultado da Lotomania 2271, de 02/07/2021.</strong></h5>
          </div> <!-- end top_right -->
