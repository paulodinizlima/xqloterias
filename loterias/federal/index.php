  ...
  <div class="containermain">
    ...
    <div class="main">
      <div class="tloterias tfederal">
        ...
        <h6><strong>LOTERIA FEDERAL - Resultados, prêmios e cidades dos ganhadores.</strong></h6>
        <span class="font14">Confira o resultado, ganhadores e prêmios da Loteria Federal. Os sorteios são realizados na segunda, terça, 
      ...
      <div class="right">        
          ...
          <div class="top_right">
            <h5><strong>Resultado da Loteria Federal 2271, de 02/07/2021.</strong></h5>
          </div> <!-- end top_right -->
