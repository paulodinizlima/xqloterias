    ...
    <div class="main">
          ...
          <?php
              ...
              require('../../paineladm/functions/conection.php');
                ...
                foreach($dados as $item){  
                  ...
                  } else if ("{$item->quid01}" != 0) { //foi sorteado
      ...
      <div class="top_right_quina">
            ...
            if($premiopost == "Aguardando..."){
              echo "<span class='text-premio-estimado'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<em>Prêmio Estimado: R$ "."{$item->quipremioest}"."</em></span>";
            } else if ($premiopost != "Aguardando..." && "{$item->quigan05}" == 0 && "{$item->quipr05}" != ""){
