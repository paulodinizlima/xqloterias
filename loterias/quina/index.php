...
<body>
    ...
    <nav class="float-r">
      <ul class="list-auto">
        ...
        <li class="quina">
          <a href="" title="Quina"><span class="icone"><img src="../../img/icon_quina.png" width="20"></span> Quina</a>
        </li>
        <li class="lotomania">
  ...
  <div class="containermain">
    ...
    <div class="main">
      <div class="tloterias tquina">
        ...
        <h6><strong>Quina - Resultado, Ganhadores e Prêmios</strong></h6>
        <span class="font14">Confira hoje o resultado, ganhadores e prêmios da Quina nos sorteios que são realizados na segunda, terça, quarta, quinta, sexta e sábado a partir das 20 horas online.</span>
